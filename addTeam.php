...
<body>
    ...
    <script>
        ...
        function nameFields() {
            if (this.value >= 1 && this.value <= 10) {
                ...
                for (var i = 1; i <= this.value; i++) {
                    ...
                    document.querySelector('.mems').appendChild(label);
                    document.querySelector('.mems').appendChild(mem);
        ...
        function check(a, b) {
            ...
            if (a.value == '<?php echo $username ?>' && b.value != '<?php echo $username ?>') {
            ...
            else if (b.value == '<?php echo $username ?>') {
                ...
                xhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        if (xhttp.responseText != "") {
                            document.querySelector('.check').innerHTML = xhttp.responseText;
                            document.querySelector('.submit').disabled = true;
                            document.querySelector(".next").style.display = "none";
                        }
                        else {
                ...
                const params = "username=" + mems[i].value + "&teamName=" + document.querySelector('.teamName').value;
        ...
        function next() {
            if (document.querySelector(".teamName").value != "") {
                ...
                document.querySelector('.check').innerHTML = "Team name cannot be empty";
            }
        }
